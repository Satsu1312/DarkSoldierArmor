...
PalladiumEvents.renderPowerScreen((event) => {
  ...
  if (!event.tab || String(event.tab) !== "satsu_iron_man_addon:items/blue_print_holder_dark_tech/main") return;
    let size = 257;
    event.guiGraphics.blit(
      new ResourceLocation(
        `satsu_iron_man_addon:textures/gui/power/blueprint_52_d.png`
      ),
      width - 126,
      height - 100,
      0,
